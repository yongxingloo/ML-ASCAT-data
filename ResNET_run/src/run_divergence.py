...
"""  Training  """
# Load data  
train_input  = np.load("../../Wind_divergence_Preprocessing/Output/Final_for_run/train_input.npy")
train_target = np.load("../../Wind_divergence_Preprocessing/Output/Final_for_run/train_target.npy")
...
test_input   = np.load("../../Wind_divergence_Preprocessing/Output/Final_for_run/test_input.npy")
test_target = np.load("../../Wind_divergence_Preprocessing/Output/Final_for_run/test_target.npy")
