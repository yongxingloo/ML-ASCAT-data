...
weight_decay   = 0#1e-5
num_epochs     = 50
model         = ResNetLayer(1, 64, 64, 1, conv=conv3x3, block=ResNetBasicBlock, n=30)
"""  Training  """
# Load data  
train_input  = np.load("../data_preperation/wind_eastward_preperation/Output/Final_for_run/train_input.npy")
train_target = np.load("../data_preperation/wind_eastward_preperation/Final_for_run/train_target.npy")
...
test_input   = np.load("../data_preperation/wind_eastward_preperation/Output/Final_for_run/test_input.npy")
test_target = np.load("../data_preperation/wind_eastward_preperation/Output/Final_for_run/test_target.npy")
...
np.save(dirs + "/DNN_output_eastward.npy", test_output)
