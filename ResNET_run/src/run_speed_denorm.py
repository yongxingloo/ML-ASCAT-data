...
"""  Training  """
# Load data  
train_input  = np.load("../data_preperation/wind_speed_preperation_no-norm/Output/Final_for_run/train_input.npy")
train_target = np.load("../data_preperation/wind_speed_preperation_no-norm/Output/Final_for_run/train_target.npy")
...
test_input   = np.load("../data_preperation/wind_speed_preperation_no-norm/Output/Final_for_run/test_input.npy")
test_target = np.load("../data_preperation/wind_speed_preperation_no-norm/Output/Final_for_run/test_target.npy")
